...
export function Sidebar({ userName, userEmail }: SidebarProps) {
  ...
  return (
    <aside className="flex h-screen w-[62px] flex-col items-center bg-sidebar py-3 dark:border-r dark:border-sidebar-border">
      {/* Piranha logo */}
      <div className="mb-3.5 flex h-9 w-9 items-center justify-center rounded-lg bg-primary">
        <svg
          width="20"
          height="16"
          viewBox="0 0 709 438"
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "relative flex h-[42px] w-[42px] flex-col items-center justify-center gap-0.5 rounded-lg transition-colors",
                isActive
